...
const OFFER_ID = '2909242d-94c5-42c5-a7d0-f1964118c440'; // id оффера который продвигаем
const WEBMASTER_TOKEN = '51e6ce86c6ce139a8b0e3128a3be82c3'; // наш id как партнера
...
$urlSuccess = 'success.php'; // там где "suc.php" - адрес страницы "спасибо" на которую редиректит клиента после отправки заявки
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
	...
	'phone' => $_POST[PHONE_FIELD],
        ...
        'offerId' => OFFER_ID,
        'domain' => "https://example.com", // рекламодатель с помощью этого файла хочет узнать адресс страницы с которой пришел клиент, но мы не передаем ему это информацию вставляя просто 
        'ip' => getUserIp(),
